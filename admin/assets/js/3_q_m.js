function q_model_body_3(mNum, qNum) {
    ...
    let output = `
<section>
    <div class="container-fluid mt-5 px-0 m_3_mdeletebody_q_`+qNum+`" style="max-width: 920px;">
        <div class="card">
            <div class="card-body">
                <h5 class="mb-4">Вопрос: выбор одного или Нескольких варианта ответа</h5>
                <div class="row mb-4">
                ...
                <button type="button" class="btn bg-survey me-3" data-bs-toggle="modal" data-bs-target="#m_3_modal_q_`+qNum+`">
                    Удалить Вопрос
                </button>
                ...
                <div class="modal-dialog  modal-dialog-centered">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn bg-survey" id="m_3_mdelete_q_`+qNum+`" data-bs-dismiss="modal">Delete</button>
                    </div>
                    </div>
                </div>
                </div>
